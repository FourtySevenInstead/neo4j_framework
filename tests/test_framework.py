...
class TestEnvironmentLoader:
    ...
    def test_pool_size_validation(self):
        ...
        assert conn.max_connection_pool_size == 100
    ...
    def test_mtls_file_validation(self, test_cert_files):
        ...
        with patch("neo4j_framework.db.connection.GraphDatabase.driver"):
            with patch(
                "neo4j_framework.db.connection.basic_auth", return_value=MagicMock()
            ):
                # Should not raise
                try:
...
class TestCustomExceptions:
    ...
    def test_exception_can_be_raised(self):
        ...
        from neo4j_framework.utils.exceptions import ValidationError
